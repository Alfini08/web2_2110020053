...
<head>
    ...
    <title>Edit Mahasiswa oleh Alfini dan 21110020053</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container mt-5">
        ...
        <div class="card">
            <form action="<?= site_url('mahasiswa/perbarui/' . $mahasiswa->id_mahasiswa) ?>" method="post">
                <div class="form-group">
                    <label for="nim">NIM</label>
                    <input type="text" class="form-control" name="nim" id="nim" value="<?php echo $mahasiswa->NIM ?>" required>
                </div>
                <div class="form-group">
                    <label for="nama_mhs">Nama Mahasiswa</label>
                    <input type="text" class="form-control" name="nama_mhs" id="nama_mhs" value="<?php echo $mahasiswa->nama_mhs ?>" required>
                </div>
                <div class="form-group">
                    <label for="nama_mhs">Program Studi</label>
